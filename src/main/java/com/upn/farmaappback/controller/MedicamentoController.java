...
public class MedicamentoController {
    ...
    @GetMapping(value = "getAllMedicamentosByName/{nombre}")
    public ResponseEntity<Object> getAllMedicamentosByName(@PathVariable String nombre){

        List<MedicamentoResponseDto> medicamentoResponseDtos = iMedicamento.getAllMedicamentosByNombre(nombre);

        if (medicamentoResponseDtos.isEmpty()) {
            String mensaje = "Medicamento no Encontrado :(";
